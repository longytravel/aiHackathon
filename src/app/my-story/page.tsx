...
const timelineStages = [
  {
    ...
    detail: "And the AI starts generating code. Beautiful, flowing code. I copy it into my editor. It works! Well... parts of it work. But I'm excited. This is amazing. I'm going to ship this in a weekend!",
  },
  {
    stage: "2. Frustration",
    emoji: "😤",
    ...
    detail: "I'm copying code from the web chat, pasting it into VS Code. Back and forth. Copy. Paste. Copy. Paste. Like it's 1998. I fix one bug... and three more appear.",
  },
  {
    ...
    detail: "Then I remember: this thing needs a safety check. AI can hallucinate. It might generate voice notes that say completely wrong things. But the codebase is already 1,000 lines of tangled spaghetti. Adding safety means ripping apart everything I've built.",
  },
  {
    ...
    detail: "I was asking the AI to hold 1,000 lines of context in its head. But AI has a limited 'working memory'—the context window. I'd filled that window to bursting. The AI was literally forgetting what we'd agreed 400 lines ago.",
  },
  {
    stage: "5. Clarity",
    emoji: "✨",
    ...
    detail: "The only thing that needed to change was ME.",
  },
];
      ...
      <div className="max-w-4xl mx-auto">
        ...
        >
          ...
          <p className="text-lg text-[#94a3b8] mb-4">
            The idea was beautiful: take those boring standardised bank letters—you know the ones, dense paragraphs nobody reads—and transform them into{" "}
            <span className="text-[#00d4ff] font-semibold">personalised digital voice notes</span>.
          </p>
